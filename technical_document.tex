...
\begin{itemize}[leftmargin=*]
	\item \textbf{GitHub Repository:} \url{https://github.com/Cruizzer/Scriptura-API}
	\item \textbf{API Endpoint Reference:} \url{https://github.com/Cruizzer/Scriptura-API/blob/main/API_ENDPOINTS.md}
	\item \textbf{API Documentation (Swagger PDF):} \url{https://github.com/Cruizzer/Scriptura-API/blob/main/Scriptura\%20API.pdf}
	\item \textbf{Presentation Slides:} \url{https://github.com/Cruizzer/Scriptura-API/blob/main/Presentation.pptx}
\end{itemize}
